...
def main():
    create_tab()
    seed_data(num_users=10, num_tasks=30)
    ...
    with conn.cursor() as cur:
        ...
        if len(user_ids) < 2:
            logging.warning("Недостаточно пользователей для демонстрации.")
            return
        ...
        queries.insert_task(cur, "Новое задание",
                            "Описание", "new", user_ids[1])
